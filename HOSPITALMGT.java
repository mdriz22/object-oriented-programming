...
void doctor_info()
{
System.out.println(did+"\t"+dname+" \t"+specilist+"\t"+appoint+"\t"+droom+"\t"+doc_qual);
}
}
class patient
{
...
d[2].did="17"; d[2].dname="Dr.Rekha"; d[2].specilist="Child spl";
...
p[1].pid="13"; p[1].pname="kuli"; p[1].disease="cold"; p[1].sex="male"; p[1].admit_status="y";
p[1].age=23;
p[2].pid="14";
p[2].pname="Gaurav";
...
p[3].pid="15"; p[3].pname="ravi"; p[3].disease="sugar"; p[3].sex="male"; p[3].admit_status="y";
p[3].age=25;
m[0].med_name="corex";
m[0].med_comp="cinopvt";
...
m[3].exp_date="12-4-12";m[3].med_cost=1100; m[3].count=100;
...
System.out.println("\nMAIN MENU");
System.out.println(" -------------------------------------------------------------------------------- ");
System.out.println("1.DOCTOR 2. PATIENT 3.MEDICAL 4.LAB 5. FACILITY 6.STAFF7.EXIT");
System.out.println(" -------------------------------------------------------------------------------- ");
